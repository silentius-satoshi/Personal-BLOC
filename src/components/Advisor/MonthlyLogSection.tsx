...
export interface MonthlyLogSectionHandle {
  focusMonth: (idx: number) => void;
}
...
export const MonthlyLogSection = forwardRef<MonthlyLogSectionHandle, MonthlyLogSectionProps>(
  function MonthlyLogSection({ months }, ref) {
    ...
    useImperativeHandle(ref, () => ({
      focusMonth: (idx: number) => {
        ...
        } else if (mn === currentMonth) {
          setForm(row ? buildFormFromRow(row) : emptyForm());
          setDetailEditing(true);
        } else {
          setDetailEditing(false);
        }
      ...
      <div className={styles.section}>
        ...
        <div className={styles.detail}>
          ...
          <div className={styles.detailHeader}>
            ...
            {!detailEditing && isCurrent && !isLogged && (
